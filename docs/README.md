...
- [`design-system.md`](design-system.md) - Viridian Blue Labs product design system for ILM: visual principles, typography roles, asset rules, layout guidance, and PR gates.
